...
export const GoogleIcon = ({ size = 20 }: { size?: number }) => (
  ...
  >
    <g>
      ...
      />
      <path
        d="M10 20c2.7 0 4.96-.89 6.61-2.41l-3.3-2.56c-.92.62-2.1.99-3.31.99-2.54 0-4.69-1.72-5.45-4.04H1.13v2.54A10 10 0 0010 20z"
        fill="#34A853"
      />
      <path
        d="M4.55 12.98A5.99 5.99 0 014.1 10c0-.99.18-1.95.45-2.98V4.48H1.13A10 10 0 000 10c0 1.64.39 3.19 1.13 4.52l3.42-2.54z"
        fill="#FBBC05"
      />
      <path
        d="M10 3.96c1.47 0 2.78.51 3.81 1.51l2.85-2.85C14.96 1.11 12.7 0 10 0A10 10 0 001.13 4.48l3.42 2.54C5.31 5.68 7.46 3.96 10 3.96z"
        fill="#EA4335"
      />
    </g>
  </svg>
...
export const AppleIcon = ({ size = 20 }: { size?: number }) => (
  ...
  >
    <g>
      <path
        d="M16.7 10.7c-.01-2.1 1.72-3.1 1.8-3.15-1-1.5-2.6-1.7-3.2-1.72-1.36-.14-2.66.8-3.36.8-.7 0-1.78-.78-2.93-.76-1.5.02-2.9.87-3.67 2.2-1.57 2.73-.4 6.77 1.12 9 .74 1.08 1.62 2.3 2.78 2.26 1.12-.05 1.54-.73 2.89-.73 1.34 0 1.72.73 2.9.71 1.2-.02 1.95-1.09 2.68-2.17.85-1.25 1.2-2.46 1.21-2.52-.03-.01-2.32-.89-2.34-3.53zm-2.2-6.6c.62-.75 1.04-1.8.93-2.85-.9.04-1.98.6-2.62 1.35-.57.66-1.08 1.72-.89 2.73 1.04.08 2.12-.53 2.58-1.23z"
        fill="#000"
      />
    </g>
  </svg>
...
export const PhoneIcon = ({ size = 20 }: { size?: number }) => (
  ...
  >
    <g>
      <rect x="3" y="2" width="14" height="16" rx="3" fill="#34A853" />
      <rect x="7" y="15" width="6" height="1" rx="0.5" fill="#fff" />
